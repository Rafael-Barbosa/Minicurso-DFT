...
dat1 = 'aluminio_po.dat'       #Entrada dos dados de difração de raios-X
dat2 = 'aluminio_placa.dat'            #Entrada dos dados de difração de raios-X 

titulo1 = "Pó" #Entrada dos dados de difração de raios-X
titulo2 = "Placa"  #Entrada dos dados de difração de raios-X
...
#set yrange [0 : 8000]				#Intervalo do eixo y para o primeiro plot
set xrange [35:90]				#Intervalo do eixo x para o primeiro plot
